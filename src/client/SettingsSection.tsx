...
export function AtFileSection({
  ...
  return (
    <section className="dsh_atFile_section" aria-labelledby="juzi-at-mention-settings-title">
      <h2 id="juzi-at-mention-settings-title" className="dsh_atFile_title">{t('settings.title')}</h2>
