/**
 * Package-owned invariant companion for `juzi-at-mention`.
 * @module juzi-at-mention/invariant
 */
...
const PACKAGE_NAME = 'juzi-at-mention'

/** Cordis companion plugin name. */
export const name = 'juzi-at-mention-invariant'
