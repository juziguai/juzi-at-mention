/**
 * Single-file client + ESM host build for juzi-at-mention.
 *
 * The web server serves exactly one file per plugin (/plugins/juzi-at-mention/client.js),
...
await build({
  ...
  banner: {
    js: "window.__ModuleLoader__.load({ id: 'juzi-at-mention', factory: (require) => { var module = { exports: {} }; var exports = module.exports;",
  },
  footer: {
